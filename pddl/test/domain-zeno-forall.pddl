(define (domain zenotravel)
  ...
  ;   :effect (oneof (and (true)) (and (not (boarding ?p ?a)) (in ?p ?a) (not-boarding ?p)))
  ; )
  ...
  ;   :effect (oneof (and (true)) (and (not (debarking ?p ?a)) (at-person ?p ?c) (not-debarking ?p)))
  ; )
  ; (:action start-flying
  ...
  ;   :effect (oneof (and (true)) (and (not (flying ?a ?c2)) (at-aircraft ?a ?c2) (not (fuel-level ?a ?l1)) (fuel-level ?a ?l2)))
  ; )
